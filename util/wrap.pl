...
BEGIN {
    ...
    require '/home/linucong/immortal_build/openssl-openssl-3.0.17/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/linucong/immortal_build/openssl-openssl-3.0.17/test/fips-and-base.cnf';
    shift;
